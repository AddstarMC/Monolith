...
public class StringTranslator
{
	...
	{
		net.minecraft.server.v1_13_R2.ItemStack base = CraftItemStack.asNMSCopy(item);
	...
	{
		net.minecraft.server.v1_13_R2.Entity base = ((CraftEntity) entity).getHandle();
		return base.getName();
	}
