...
public class EntityUtil
{
	...
	public static <T extends Entity> List<T> getEntitiesWithin(World world, BoundingBox bb, Class<T> type)
	{
		...
		List<net.minecraft.server.v1_8_R2.Entity> rawResults = ((CraftWorld)world).getHandle().a(net.minecraft.server.v1_8_R2.Entity.class, rawBB, (Predicate<net.minecraft.server.v1_8_R2.Entity>)null);
		List<T> resolved = Lists.newArrayListWithCapacity(rawResults.size());
		for (Object rawResult : rawResults)
		{
			net.minecraft.server.v1_8_R2.Entity nmsEntity = (net.minecraft.server.v1_8_R2.Entity)rawResult;
