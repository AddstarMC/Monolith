...
public class Village
{
	...
	static
	{
		try
		{
			mFieldWorld = net.minecraft.server.v1_8_R2.Village.class.getDeclaredField("a");
	...
	private net.minecraft.server.v1_8_R2.Village mHandle;
	
	private Village(net.minecraft.server.v1_8_R2.Village handle)
	{
		mHandle = handle;
	}
	...
	public World getWorld()
	{
		try
		{
			net.minecraft.server.v1_8_R2.World world = (net.minecraft.server.v1_8_R2.World)mFieldWorld.get(mHandle);
	...
	static Village getVillage(Villager villager, Village cached)
	{
		try
		{
			net.minecraft.server.v1_8_R2.Village handle = (net.minecraft.server.v1_8_R2.Village) mFieldVillage.get(((CraftVillager)villager).getHandle());
			if (handle == null)
				return null;
	...
	{
		net.minecraft.server.v1_8_R2.Village handle = ((CraftIronGolem)golem).getHandle().n();
		if (handle == null)
			return null;
